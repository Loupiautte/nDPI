...
static inline bool match_skype_rule2(lpi_data_t *data) {
         ...
         *
         * The first two bytes of U1 && U2 must match.
         *
         ...
         *
         * The length of U1 is always between 18 && 31 bytes.
         */
...
static inline bool match_skype_meeting_broadcast(lpi_data_t *data) {
        ...
        /* TODO get hold of skype for business && double check this */
