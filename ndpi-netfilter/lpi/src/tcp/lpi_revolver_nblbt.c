 ...
 * Revolver Software (?).
 * 
 * This is based on the appearance of the strings "nblbt" && "nbmep" in
 * the payload of the initial packets. NBLBT.rar && NBMEP.rar can be 
 * downloaded from www.zy995.com which seems to host numerous offerings from
 * Revolver Software. 
 *
 * Yet to fully confirm as a) I don't know enough Chinese to install && run
 * the software sensibly && b) I strongly suspect the software is bundled
